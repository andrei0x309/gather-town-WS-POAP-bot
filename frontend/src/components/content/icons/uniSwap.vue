<template>
  <svg class="inline w-4" version="1.1" x="0px" y="0px" viewBox="0 0 168.3 193.8" xml:space="preserve">
    <path
      fill="#FF007A"
    ...
    c-3.4-2.3-7-3-16.5-3.5c-8.6-0.5-13.5-1.2-18.3-2.8c-8.2-2.7-12.4-6.2-22.1-19.1c-4.3-5.7-7-8.8-9.7-11.4 C79.6,48.3,73.7,45.3,66,44.1z"
    />
    <path
      fill="#FF007A"
    ...
    />
    <path
      style="fill-rule: evenodd; clip-rule: evenodd; fill: #ff007a"
